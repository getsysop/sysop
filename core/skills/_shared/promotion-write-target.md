...
| **`scripts/hooks/pre-commit` letter** (option iii) | append the check | *none* — `scripts/hooks/*` is preserved as a consumer-modified managed path (Phase 24b), so the appended letter survives |
